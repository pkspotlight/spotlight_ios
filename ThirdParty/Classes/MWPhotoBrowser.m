...
- (void)viewDidLoad {
    ...
    if (self.displayNavArrows) {
        UIImage *previousButtonImage = [UIImage imageNamed:@"Left"];
        UIImage *nextButtonImage = [UIImage imageNamed:@"Right"];
...
- (void)performLayout {
    ...
    // Right - Action
    if (_actionButton && !(!hasItems && !self.navigationItem.rightBarButtonItems)) {
...
//                [playButton setImage:[UIImage imageNamed:@"PlayButtonOverlayLargeTap"] forState:UIControlStateHighlighted];
                ...
                [playButton setImage:[UIImage imageNamed:@"PlayButtonOverlayLarge.png"] forState:UIControlStateNormal];
                [playButton setImage:[UIImage imageNamed:@"PlayButtonOverlayLargeTap.png"] forState:UIControlStateHighlighted];
